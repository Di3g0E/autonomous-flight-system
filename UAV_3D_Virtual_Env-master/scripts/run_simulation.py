...
# Add project root to sys.path to allow imports if package is not installed
...
# Custom Functions
from src.simulation.position import quad_position
from src.vision.quadrotor_cv import computer_vision
...
class MyApp(ShowBase):
    def __init__(self):
        ...
        # Initialize simulation and vision tasks
        self.run_setup()
