#!/usr/bin/env python
"""
Hover-track v7.4 — survival-incentivising reward + motor-saturation cap.
...
def parse_args():
    ...
    p.add_argument('--output-dir', type=str, default='./models/hover_track_v7_4')
...
class HoverTrackV7App(ShowBase):
    def __init__(self, args):
        ...
        print("\n" + "=" * 70)
        print("  HOVER-TRACK v7.4 — survival-incentive + amag cap")
        print("=" * 70)
    ...
    def run_training(self):
        ...
        self.curriculum_cb.save_metrics(extras={
            ...
            'reward_version': ('v7.4 (custom: growing alive + α·track + '
                               'invisible + jerk + amag)'),
            'reward_weights': {
